import { Button } from "@/components/ui/button";import Link from "next/link";export default function Home() {  return (  // <div className="h-[100vh] flex items-center justify-center gap-8 flex-col">
  ...
  <div className="h-[100vh] flex items-center justify-center gap- flex-col">
    <div className="mx-auto my-auto max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap0 relative">
        ...
        <div className="col-span-full md:col-span-2 border-y border-muted-foreground/30 border-dashed py-8">
          <h1 className=" font-extrabold tracking-tight sm:text-4xl md:text-5xl text-center">
